...
export const HARNESS_CATALOG = [
  ...
  { id: 'oagent', displayName: 'OAgent', family: 'coordinator', mechanism: 'best-of-N rollouts with list-wise selection', primarySource: 'https://github.com/OPPO-PersonalAI/OAgents' },
  ...
  { id: 'hiagent', displayName: 'HiAgent', family: 'in-loop', mechanism: 'value-sampled trajectory memory', primarySource: 'https://github.com/HiAgent2024/HiAgent' },

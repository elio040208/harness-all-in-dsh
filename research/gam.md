...
- The original creates abstracts in a separate Memorizer call. DSH requires the conversation model to emit the same abstract through a guarded tool call after it has observed the complete tool result.
